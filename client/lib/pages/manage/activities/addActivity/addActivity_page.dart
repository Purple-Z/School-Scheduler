        ...
        children: [
          SingleChildScrollView(
            child: Column(
              ...
              children: [
                Text(
                  AppLocalizations.of(context)!.activity_add_new_activity,
                  style: TextStyle(fontSize: 25, fontWeight: FontWeight.bold),
                ),
                const SizedBox(height: 30),

                buildTextField(nameController, AppLocalizations.of(context)!.activity_name, Icons.abc),
                SizedBox(height: fieldsSpacing),
                buildTextField(descriptionController, AppLocalizations.of(context)!.activity_description, Icons.type_specimen),
                SizedBox(height: fieldsSpacing),
              ],
            ),
          ),
          ...
          Center(
            child: ElevatedButton(
              ...
              onPressed: () async {
                if (await Connection.addActivity(
                    name: nameController.text,
                    description: descriptionController.text,
                    appProvider: appProvider
                )){
                  showTopMessage(context, AppLocalizations.of(context)!.activity_create_success);
                  context.pop();
                } else {
